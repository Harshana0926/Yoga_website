...
const Navbar = () => {
    ...
    const [navBg, setNavBg] = useState('bq-[#15151580]')
    const user = true;
              ...
              <ul className='ml-10 flex items-center space-x-4 pr-4'>
                {
                  navLinks.map(link => (
                    <li key={link.route}>
                      ...
                      className={({isActive})=>
                    `font-bold ${isActive ? 'text-secondary':`S{navBg:includes('bg-transparent')? 'text-white':'text-black dark:text-white'}`} hover:text-secondary duration-30`
                    }
                    >
                        {link.name}
                        </NavLink>
                 ...
                 <NavLink to="/register" className={({isActive})=>
                    `font-bold ${isActive ? 'text-secondary':`S{navBg:includes('bg-transparent')? 'text-white':'text-black dark:text-white'}`} hover:text-secondary duration-300`
                    } >Register</NavLink>
                 </li>) :  (<li>
